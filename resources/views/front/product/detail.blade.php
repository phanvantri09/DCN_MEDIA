            ...
            <div class="row">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="single-product-content">
                        <h3 class="title">{{$data['name']}} <span
                                style="font-size: 15px; color: #666; font-weight: normal;">({{ $data['warranty_months'] == 0 ? 'sản phẩm không bảo hành' : 'bảo hành: ' . $data['warranty_months'] . ' tháng' }})</span>
                        </h3>
                        <span class="prices">
                        ...
                        <div class="product-ratings">
                            ...
                            <a href="#reviews" class="review-link">(<span
                                    class="count">{{ $data['total_reviews'] ?? 0 }}</span>
                        ...
                        <div class="entry-product-share">
                            ...
                            <div class="author-social-networks">
                                <div class="inner">
                                    ...
                                    <a class="hint--bounce hint--top hint--primary" aria-label="Facebook"
                                        href="https://www.facebook.com/dcn.media1163" target="_blank">
                                        <i class="fab fa-facebook-f"></i>
                                    </a>

                                    <a class="hint--bounce hint--top hint--primary" aria-label="Twitter"
                                        href="https://www.facebook.com/dcn.media1163" target="_blank">
                                        <i class="fab fa-twitter"></i>
                                    </a>

                                    <a class="hint--bounce hint--top hint--primary" aria-label="Linkedin"
                                        href="https://www.facebook.com/dcn.media1163" target="_blank">
                                        <i class="fab fa-linkedin"></i>
                                    </a>

                                    <a class="hint--bounce hint--top hint--primary" aria-label="Tumblr"
                                        href="https://www.facebook.com/dcn.media1163" target="_blank">
