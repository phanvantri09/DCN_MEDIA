            ...
            <div class="row row-cols-xl-3 row-cols-md-2 row-cols-1 mb-xl-n12 mb-n6">
                <div class="col mb-xl-12 mb-6" data-aos="fade-up">
                    ...
                    <div class="blog blog-grid-style-two">
                        <div class="thumbnail">
                            <a href="blog-details.html" class="image"><img src="assetsUserSite/images/blog/grid/blog-3.jpg"
                                    alt="Blog Image"></a>
                            <span class="badge"><i class="fal fa-quote-left"></i></span>
                        </div>
                        <div class="info">
                            <h3 class="title"><a href="blog-details.html">Untangling wicked digital problems</a></h3>
                            <ul class="meta">
                                <li>19 Augs, 2018 - by John Snow</li>
                                <li><a href="#">Gym,</a> <a href="#">Healthy</a></li>
                            </ul>
                            <div class="desc">
                                <p>Lorem ipsum dolor sit amet, magna habemus ius ad, qui minimum voluptaria in. Ad mei modus
                                    quodsi complectitur, postea verterem persecuti cu est, sea epicuri.</p>
                            </div>
                            <a href="#" class="btn btn-outline-secondary btn-hover-primary fz-10">READ MORE</a>
                        </div>
                    </div>
