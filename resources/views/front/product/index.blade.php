    ...
    <script>
        $(document).ready(function () {
            ...
            $('.filter-option').click(function (e) {
                ...
                if (filterValue.startsWith('limit_')) {
                    limit = parseInt(filterValue.replace('limit_', ''));
                    filter = 'all'; // Reset filter danh mục khi thay đổi số lượng
                } else {
                    filter = filterValue; // Filter theo danh mục hoặc all
                }
            ...
            function loadProducts(offset, limit, sort, filter) {
                $.ajax({
                    ...
                    success: function (response) {
                        console.log(response); // Debug phản hồi
                    ...
                    error: function (xhr) {
                        console.error('Error:', xhr); // Debug lỗi
